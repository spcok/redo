...
const FullAnimalSchema = z.object({
    ...
    flying_weight_g: z.number().nullable(),
    winter_weight_g: z.number().nullable(),
    average_target_weight: z.number().nullable(),
    ...
    target_day_temp_c: z.number().nullable(),
    target_night_temp_c: z.number().nullable(),
    water_tipping_temp: z.number().nullable(),
    target_humidity_min_percent: z.number().nullable(),
    target_humidity_max_percent: z.number().nullable(),
